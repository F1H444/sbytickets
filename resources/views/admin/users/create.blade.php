...
@section('content')
    <div class="space-y-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-black text-gray-900 tracking-tight">Tambah Pengguna Baru</h1>
                <p class="text-gray-500 mt-1">Buat akun pengguna baru dengan peran tertentu.</p>
            </div>
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-8 max-w-3xl">
            <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        <label for="password"
                            class="text-sm font-bold text-gray-700 uppercase tracking-widest text-[11px]">Kata Sandi</label>
                    ...
                    <div class="space-y-2">
                        <label for="password_confirmation"
                            class="text-sm font-bold text-gray-700 uppercase tracking-widest text-[11px]">Konfirmasi
                            Kata Sandi</label>
