...
@section('content')
    <div class="max-w-4xl mx-auto space-y-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-black text-gray-900 tracking-tight">Tambah Wisata Baru</h1>
                <p class="text-gray-500 mt-1">Lengkapi informasi untuk menambahkan destinasi baru.</p>
            </div>
        </div>
            ...
            <div class="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="base_price_weekday" value="{{ old('base_price_weekday') }}" required
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <span class="absolute left-4 top-3.5 text-gray-400 font-bold">Rp</span>
                            <input type="number" name="base_price_weekend" value="{{ old('base_price_weekend') }}" required
                                class="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-purple-500 focus:bg-white transition-all outline-none"
                                placeholder="0">
                        </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" name="capacity_per_day" value="{{ old('capacity_per_day', 100) }}" required
                            class="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-purple-500 focus:bg-white transition-all outline-none"
                            placeholder="100">
                    ...
                    <div class="space-y-2 text-center flex flex-col justify-center">
                        ...
                        <div class="flex items-center justify-center gap-6">
                            ...
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="radio" name="is_active" value="0" class="w-4 h-4 text-gray-400">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="description" rows="4" required
                        ...
                        placeholder="Ceritakan tentang daya tarik wisata ini...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1 font-bold">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group mt-2">
                        ...
                        <label for="image"
                            ...
                            <div id="placeholder" class="space-y-2 text-center">
                                ...
                                <span class="text-gray-400 font-bold block">Klik untuk upload foto</span>
                                <span class="text-[10px] text-gray-300 uppercase tracking-widest">JPEG, PNG, WEBP (Max
                                    2MB)</span>
                            </div>
